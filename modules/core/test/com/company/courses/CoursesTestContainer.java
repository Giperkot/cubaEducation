...
public class CoursesTestContainer extends TestContainer {

    public CoursesTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/courses/app.properties",
    ...
    public static class Common extends CoursesTestContainer {

        public static final CoursesTestContainer.Common INSTANCE = new CoursesTestContainer.Common();
